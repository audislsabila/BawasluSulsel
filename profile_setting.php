                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
                                                    <option value="Laki-laki" <?= 
                                                        ($user['jenis_kelamin'] ?? $defaultValues['jenis_kelamin']) == 'Laki-laki' ? 'selected' : '' ?>>Laki-Laki</option>
                                                    <option value="Perempuan" <?= 
                                                        ($user['jenis_kelamin'] ?? $defaultValues['jenis_kelamin']) == 'Perempuan' ? 'selected' : '' ?>>Perempuan</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
