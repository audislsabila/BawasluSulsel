            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    Tambah Laporan
                                        ...
                                        <div class="modal fade" id="delete<?=$idL;?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                Apakah Anda yakin ingin menghapus kegiatan rapat <strong><?=$idL;?></strong>?
                                                                <input type="hidden" name="id_kegiatan" value="<?=$idL;?>">                                                                 <br><br>
                        ...
                        <!-- Tombol Cetak di Bawah, Tengah Halaman -->
                                <div style="text-align: center;">
                                    <a href="print_version.php" target="_blank">
                                <div class="btn btn-primary">Versi Cetak </div>
                                </a>
                            </div>
                         </div>
                     </div>
