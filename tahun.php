...
function handleLaporanBulanan() {
    ...
    if(isset($_POST['addlaporanbulanan'])) {
       ...
       // Update query dan binding parameter
            $stmt = $conn->prepare("INSERT INTO laporan_bulanan 
            (judul, bulan, tahun, isi_laporan, file_lampiran, tanggal_upload, waktu) 
            VALUES (?, ?, ?, ?, ?, ?, ?)");
            ...
            $file_lampiran, 
            $tanggal_upload,
            $waktu // Tambahan parameter waktu
        );
                                    ...
                                    <!-- Edit Modal -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Edit Laporan Bulanan</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_laporan" value="<?=$idL;?>">
                                                            <input type="hidden" name="old_file" value="<?=$file_lampiran;?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="isi_laporan" class="form-control" rows="4" required><?=$isi_laporan;?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>File Lampiran (PDF, Word, Excel)</label>
                                                                <input type="file" name="file_lampiran" class="form-control" accept=".pdf,.doc,.docx,.xls,.xlsx">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Tanggal Upload</label>
                                                                <input type="date" name="tanggal_upload" value="<?=$tanggal_upload;?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Waktu Upload</label>
                                                                <input type="time" name="waktu" value="<?= $waktu ?>" class="form-control" required>
                                                            </div>
                                                            <button type="submit" class="btn btn-primary" name="updatelaporanbulanan">Update</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="delete<?=$idL;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Hapus Laporan Bulanan</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus laporan bulanan <strong><?=$idL;?></strong>?
                                                            <input type="hidden" name="id_laporan" value="<?=$idL;?>">
                                                            <br><br>
                                                            <button type="submit" class="btn btn-danger" name="hapuslaporanbulanan">Hapus</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Laporan Bulanan</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary" name="addlaporanbulanan">Simpan</button>
                </div>
            </form>
        </div>
    </div>
